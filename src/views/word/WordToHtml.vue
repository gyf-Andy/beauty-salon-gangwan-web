<template>
  ...
  <a-affix :offset-top="10" style="position: absolute;margin-top: 20px;margin-left: 40px;">
    <a-tooltip  title="WORD转HTML" color="yellow" placement="bottom">
      <a-button type="link" shape="circle" style="height: 60px;width: 60px;background: #dddddd">
        <embed src="svg/word-html.svg" type="image/svg+xml" style="width: 40px"/>
      </a-button>
    </a-tooltip>
  </a-affix>
  <a-row type="flex" justify="center" style="margin-top: 50px">
    ...
    <a-col :span="8">
      <a-card class="setShadow" size="small" title="文档预览">
        <div style="height: 302px; border: 1px dashed;width: auto;text-align: center;background: #d8ffbf;">

          <template v-if="newFileUrl==''" >
          ...
          <template v-if="newFileUrl!==''">
              ...
              <iframe style="background: white" :src='newFileUrl' width='100%' height='100%'  frameborder='0' >
              </iframe>
...
import { InboxOutlined,FileSyncOutlined,DownloadOutlined,FileWordOutlined } from '@ant-design/icons-vue';
import { reactive, toRefs,watch} from "vue";
import {message} from "ant-design-vue";
import { wordToHtml, } from "@/api/word";
...
export default {
  ...
  setup() {
    const state=reactive({
      ...
      uploading:false,
      preview:true,
      parseUrl:'https://view.officeapps.live.com/op/view.aspx?src=',
      oldFileUrl:'',
      newFileUrl:'',
